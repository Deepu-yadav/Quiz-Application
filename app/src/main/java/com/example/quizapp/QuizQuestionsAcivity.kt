...
import kotlinx.android.synthetic.main.activity_quiz_questions_acivity.*

class QuizQuestionsAcivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_quiz_questions_acivity)
    ...
    private fun setQuestion(){
        ...
        tv_option_one.text=question.optionsOne
        tv_option_two.text=question.optionsTwo
        tv_option_three.text=question.optionsThree
        tv_option_four.text=question.optionsFour
